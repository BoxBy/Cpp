...
int main() {
	...
	str4.println();
	cout << endl;
	cout << "find a word in str4" << endl;
	cout << "find 1th <very> in the str4 : " << str4.find(0, "very") << endl;
	cout << "find 2th <very> in the str4 : " << str4.find(str4.find(0, "very") + 1, "very") << endl;
